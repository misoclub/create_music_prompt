...
出力するタグなしの歌詞は表示に使用するので。24文字を超える場合は英語的に違和感のない位置に「改行コード(\\n)を文字として書き込んでください。」
24文字を超えない場合は改行しなくていいです。
もともとの歌詞を考えるときには24文字を超えるとかは考慮しなくていいです。あくまで表示のときに超えると問題があるので、タグなし歌詞を出力するときのみ処理してください。
